...
<head>
    ...
    <title>MFA - MuseDock Panel</title>
...
<body>
    <div class="login-card">
        <div class="text-center mb-3">
            <i class="bi bi-shield-lock" style="font-size: 2.5rem; color: #38bdf8;"></i>
        </div>
        ...
        <form method="POST" action="/login/mfa/verify">
            <?= View::csrf() ?>
            <div class="mb-3">
                <label class="form-label">Codigo de 6 digitos</label>
                <input type="text" name="mfa_code" class="form-control" placeholder="123456" required autofocus inputmode="numeric" pattern="[0-9]{6}" maxlength="6">
            </div>
            <button type="submit" class="btn btn-login btn-primary">
                <i class="bi bi-check2-circle me-1"></i> Verificar y acceder
            </button>
        </form>

        <div class="text-center mt-3">
            <a href="/login" style="color:#93c5fd;text-decoration:none;font-size:0.85rem;">
